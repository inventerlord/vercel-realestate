...
import { BadgeCheck, Bell, ChevronsUpDown, CreditCard, GalleryVerticalEnd, LogOut, Sparkles } from "lucide-react";
...
// import profileImage from '../../assets/default/profile-3.jpg'
// import profileImage from '@/assets/default/profile-3.jpg'
...
const SidebarPanel = () => {
  ...
  const handleLogout = () => {
      dispatch(logout());
      navigate('/login') // clear token or auth state
    };
  return (
